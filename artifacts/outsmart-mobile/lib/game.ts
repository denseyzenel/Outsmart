...
export const STORAGE_KEY = "outsmart-progress-v1";
export const VERSION = 2;
export const LEGACY_STORAGE_KEY = "outsmart-progress-v1";
...
export function normalizeDaily(daily: Partial<DailyState> | undefined): DailyState {
